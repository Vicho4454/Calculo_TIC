...
Original file is located at
    https://colab.research.google.com/drive/16rg10OywllpNsLXiRA_eUh7XySYfV7Pe
"""
...
# Función para graficar la trayectoria de T y P
...
# Función para graficar la distancia d(t) entre P y S
...
# Botón para graficar la distancia d(t)
